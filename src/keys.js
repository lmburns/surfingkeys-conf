...
// TODO:
// Change: C  Open link in non active tab
// Change: B  Go one tab history back
// Change: s  scroll down
// Change: w  scroll up
// Change: e  scroll half page up

// Visual
// Map:    #  search text
// Duplicates
// Unmap:  *  find selected text in current page
// Unmap:  *  search word under cursor
...
maps.global = [
  ...
  // ╰─────────╯
  {
    ...
    description: "Forward lineboundary",
  },
  {
    mode:        "v",
    alias:       "H",
    map:         "0",
    category:    categories.visualMode,
    description: "Backward lineboundary",
  },
  // ╭──────────╮
  // │  Command │
  // ╰──────────╯
  ...
  },
  {
    ...
    description: "Open Chrome flags",
    callback:    () => actions.openLink("chrome://flags/", {newTab: true}),
  },
  {
    alias:       "=W",
  ...
  },
  {
    alias:       "=p",
    category:    categories.misc,
    description: "Show Archive.ph archive for page",
    callback:    () => actions.openLink(actions.getArchivephUrl(), {newTab: true}),
  },
  {
    alias:       "=P",
    category:    categories.misc,
    description: "Show Archive.is archive for page",
    callback:    () => actions.openLink(actions.getArchiveisUrl(), {newTab: true}),
  },
  {
    alias:       "=A",
    category:    categories.misc,
...
maps["github.com"] = [
  ...
  {
    alias:       "F",
    description: "Open repository forks",
    callback:    actions.gh.openForks,
  },
  {
    alias:       "a",
  ...
  },
  {
    ...
    callback:    () => Clipboard.write(util.getURLPath({count: 2, domain: true})),
  },
  {
    alias:       "l",
